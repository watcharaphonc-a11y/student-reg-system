    ...
    if (isNewCurriculum) {
        if (dept.includes('ผู้ใหญ่') || programId === 'nursing-adult') {
            planData = [
                ...
                {
                    year: 2, sem: 1, title: 'ชั้นปีที่ 2 ภาคการศึกษาที่ 1', credits: 3, courses: [
                        '0100500217 วิทยานิพนธ์ (Thesis) 3 (0-9-3)'
                    ]
                },
                {
                    year: 2, sem: 2, title: 'ชั้นปีที่ 2 ภาคการศึกษาที่ 2', credits: 9, courses: [
                        '0100500217 วิทยานิพนธ์ (Thesis) 9 (0-27-9)'
                    ]
                }
            ];
            ...
            planData = [
                {
                    year: 1, sem: 1, title: 'ชั้นปีที่ 1 ภาคการศึกษาที่ 1', credits: 11, courses: [
                        '01005000101 ระบบสุขภาพ ภาวะผู้นำทางการพยาบาล จริยธรรมและกฎหมายสุขภาพ 3 (3-0-6)',
                        '01005000102 ทฤษฎีและแนวคิดทางการพยาบาล 2 (2-0-4)',
                        '0100509105 การประเมินสุขภาพขั้นสูงและเภสัชวิทยาสำหรับการรักษาโรคเบื้องต้น 2 (1-2-3)',
                        '0100509106 การพยาบาลเวชปฏิบัติชุมชนในการดูแลบุคคลและครอบครัวที่มีปัญหาสุขภาพซับซ้อน 2 (2-0-4)',
                        '0100509107 การพยาบาลเวชปฏิบัติชุมชนกับการพัฒนาระบบบริการสุขภาพชุมชน 2 (2-0-4)'
                    ]
                },
                {
                    year: 1, sem: 2, title: 'ชั้นปีที่ 1 ภาคการศึกษาที่ 2', credits: 10, courses: [
                        '01005000103 วิจัยและหลักฐานเชิงประจักษ์ทางการพยาบาล 2 (2-0-4)',
                        '01005000104 สถิติประยุกต์ในการวิจัยทางการพยาบาล 2 (1-2-3)',
                        '0100509108 ปฏิบัติการพยาบาลเวชปฏิบัติชุมชนในการดูแลบุคคลและครอบครัวที่มีปัญหาสุขภาพซับซ้อน 3 (0-9-3)',
                        'xxxxxxxxxxx วิชาเลือกเสรี 3 (x-x-x)'
                    ]
                },
                {
                    year: 1, sem: 3, title: 'ชั้นปีที่ 1 ภาคฤดูร้อน', credits: 3, courses: [
                        '0100509109 ปฏิบัติการพยาบาลเวชปฏิบัติชุมชนกับการพัฒนาระบบบริการสุขภาพชุมชน 3 (0-9-3)'
                    ]
                },
                {
                    year: 2, sem: 1, title: 'ชั้นปีที่ 2 ภาคการศึกษาที่ 1', credits: 3, courses: [
            ...
            // Shared Core Courses for Pediatric layout
            const coreS1 = [
            ...
            if (dept.includes('เด็ก') || programId === 'nursing-pediatric') {
                ...
                branchS1 = ['0100508101 ภาวะผู้นำและการจัดการคุณภาพองค์กรสุขภาพ 2 (2-0-4)'];
                branchS2 = [
                ...
                branchS3 = [
                    ...
                    '0100508106 สัมมนาประเด็นคัดสรรในการบริหารทางการพยาบาลและองค์กรสุขภาพ 1 (0-2-1)'
                ];
            } else {
                // Default/Other generic 36-credit layout matching Pediatric structure
            ...
            // Create planData from Pediatric-style layout
            planData = [
