...
window.getStudyPlanForStudent = function(student) {
    ...
    if (isNewCurriculum) {
        ...
        if (dept.includes('ผู้ใหญ่') || programId === 'nursing-adult') {
            branchS1 = ['0100504105 พยาธิสรีรวิทยาและเภสัชวิทยาทางการพยาบาลผู้ใหญ่และผู้สูงอายุ 3 (3-0-6)', '0100504106 การพยาบาลผู้ใหญ่และผู้สูงอายุ 3 (3-0-6)'];
            branchS2 = ['0100504107 ปฏิบัติการพยาบาลผู้ใหญ่และผู้สูงอายุ 1 3 (0-9-3)'];
            branchS3 = ['0100504108 ปฏิบัติการพยาบาลผู้ใหญ่และผู้สูงอายุ 2 3 (0-9-3)'];
            branchS4.push('0100500217 วิทยานิพนธ์ 1 3 (0-9-3)');
            branchS5 = ['0100500218 วิทยานิพนธ์ 2 9 (0-27-9)'];
        } else if (dept.includes('เด็ก') || programId === 'nursing-pediatric') {
            branchS1 = ['0100505105 พยาธิสรีรวิทยาและเภสัชวิทยาทางการพยาบาลเด็ก 3 (3-0-6)', '0100505106 การพยาบาลเด็ก 3 (3-0-6)'];
            branchS2 = ['0100505107 ปฏิบัติการพยาบาลเด็ก 1 3 (0-9-3)'];
            branchS3 = ['0100505108 ปฏิบัติการพยาบาลเด็ก 2 3 (0-9-3)'];
            branchS4.push('0100500217 วิทยานิพนธ์ 1 3 (0-9-3)');
            branchS5 = ['0100500218 วิทยานิพนธ์ 2 9 (0-27-9)'];
        } else if (dept.includes('ผดุงครรภ์') || programId === 'nursing-maternal') {
            branchS1 = ['0100506105 พยาธิสรีรวิทยาและเภสัชวิทยาสำหรับการผดุงครรภ์ 3 (3-0-6)', '0100506106 การผดุงครรภ์ชั้นสูง 3 (3-0-6)'];
            branchS2 = ['0100506107 ปฏิบัติการผดุงครรภ์ 1 3 (0-9-3)'];
            branchS3 = ['0100506108 ปฏิบัติการผดุงครรภ์ 2 3 (0-9-3)'];
            branchS4.push('0100500217 วิทยานิพนธ์ 1 3 (0-9-3)');
            branchS5 = ['0100500218 วิทยานิพนธ์ 2 9 (0-27-9)'];
        } else if (dept.includes('จิตเวช') || programId === 'nursing-mental') {
            branchS1 = ['0100507105 จิตพยาธิวิทยาและเภสัชวิทยาทางจิตเวช 3 (3-0-6)', '0100507106 การพยาบาลจิตเวชและสุขภาพจิต 3 (3-0-6)'];
            branchS2 = ['0100507107 ปฏิบัติการพยาบาลจิตเวชและสุขภาพจิต 1 3 (0-9-3)'];
            branchS3 = ['0100507108 ปฏิบัติการพยาบาลจิตเวชและสุขภาพจิต 2 3 (0-9-3)'];
            branchS4.push('0100500217 วิทยานิพนธ์ 1 3 (0-9-3)');
            branchS5 = ['0100500218 วิทยานิพนธ์ 2 9 (0-27-9)'];
        } else if (dept.includes('ชุมชน') || programId === 'nursing-community') {
            branchS1 = ['100509105 การประเมินสุขภาพขั้นสูงและเภสัชวิทยาสำหรับการรักษาโรคเบื้องต้น 3 (3-0-6)', '100509106 การพยาบาลเวชปฏิบัติชุมชน 3 (3-0-6)'];
            branchS2 = ['100509108 ปฏิบัติการพยาบาลเวชปฏิบัติชุมชน 1 3 (0-9-3)'];
            branchS3 = ['100509109 ปฏิบัติการพยาบาลเวชปฏิบัติชุมชน 2 3 (0-9-3)'];
            branchS4.push('0100500217 วิทยานิพนธ์ 1 3 (0-9-3)');
            branchS5 = ['0100500218 วิทยานิพนธ์ 2 9 (0-27-9)'];
        } else if (dept.includes('บริหาร') || programId === 'nursing-admin') {
            branchS1 = ['0100508105 นโยบายและการจัดการระบบสุขภาพ 3 (3-0-6)', '0100508106 การบริหารทางการพยาบาล 3 (3-0-6)'];
            branchS2 = ['0100508107 ปฏิบัติการบริหารทางการพยาบาล 1 3 (0-9-3)'];
            branchS3 = ['0100508108 ปฏิบัติการบริหารทางการพยาบาล 2 3 (0-9-3)'];
            branchS4.push('0100500217 วิทยานิพนธ์ 1 3 (0-9-3)');
            branchS5 = ['0100500218 วิทยานิพนธ์ 2 9 (0-27-9)'];
        } else {
            // Default/Other
            branchS1 = ['0100500XXX วิชาเฉพาะสาขา 1 3 (3-0-6)', '0100500XXX วิชาเฉพาะสาขา 2 3 (3-0-6)'];
            branchS2 = ['0100500XXX ปฏิบัติการเฉพาะสาขา 1 3 (0-9-3)'];
            branchS3 = ['0100500XXX ปฏิบัติการเฉพาะสาขา 2 3 (0-9-3)'];
            branchS4.push('0100500217 วิทยานิพนธ์ 1 3 (0-9-3)');
            branchS5 = ['0100500218 วิทยานิพนธ์ 2 9 (0-27-9)'];
        }
